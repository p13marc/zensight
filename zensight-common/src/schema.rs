...
pub static SCHEMAS: LazyLock<SchemaSet> = LazyLock::new(|| {
    SchemaSet::builder("zensight")
        ...
        .json::<crate::StreamDiscoveryReport>("StreamDiscoveryReport")
        ...
        .json::<crate::pve::PveNode>("PveNode")
        .json::<crate::pve::PveBackupSchedule>("PveBackupSchedule")
        .json::<crate::pve::PveCephStatus>("PveCephStatus")
