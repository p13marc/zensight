...
pub fn command_key(producer: &str, topic: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).rpc_key(&[topic, "set"]).into()
}
...
pub fn status_key(producer: &str, topic: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).rpc_key(&[topic]).into()
}
...
pub fn artifact_request_key(producer: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).rpc_key(&["artifact", "request"]).into()
}
...
pub fn artifact_status_key(producer: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).rpc_key(&["artifact", "status"]).into()
}

/// The artifact-cancel write procedure (`?id=<ulid>`).
pub fn artifact_cancel_key(producer: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).rpc_key(&["artifact", "cancel"]).into()
}
...
pub fn artifact_blob_prefix(producer: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).blob_prefix(BlobTier::Artifact).into()
}
...
pub fn artifact_store_prefix(producer: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).blob_prefix(BlobTier::Store).into()
}

/// Tier-2 tree-index prefix: `<base>/v1/<origin>/@blob/tree`.
pub fn artifact_tree_prefix(producer: &str) -> String {
    V1Context::for_producer(&crate::PROFILE, producer).blob_prefix(BlobTier::Tree).into()
}
