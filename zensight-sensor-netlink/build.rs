...
//! never invokes `aya-build` / `bpf-linker` or needs nightly. (#114)
//!
...
fn build_ebpf() {
    ...
    // include_bytes_aligned!. Uses the `nightly` toolchain via `rustup run`
    // (needs rust-src + bpf-linker installed).
